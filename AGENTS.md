...
Libadwaita. It streams local Ollama chat, gives models root-confined file tools and
...
- `localcode/database.py` persists projects, chats, full messages, activities, and settings in SQLite.
...
- Keep GTK calls on the main loop. Ollama, shell commands, and MemPalace run in workers.
